...
{
    ImVec2 contentRegion = ImVec2(  fWidthOverride == 0.0f ? 
                                           ImGui::GetContentRegionAvail().x : fWidthOverride, 
                                    fHeightOverride == 0.0f ? 
                                            ImGui::GetContentRegionAvail().y : fHeightOverride);
